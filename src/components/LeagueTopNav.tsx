...
export function LeagueTopNav() {
  ...
  const moreItems = [
    { label: 'Trade Machine', path: `${base}/trade-machine` },
  ...
  const navItems = [
    ...
    {
      label: 'Draft Room', to: `${base}/draft`, active: path === `${base}/draft`,
      icon: (sw: number) => <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={sw}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>,
    },
    {
