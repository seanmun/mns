...
export function LeagueBottomNav() {
  ...
  const moreItems = [
    ...
    { label: 'Draft History', path: `${base}/draft-history`, section: 'Draft' },
    ...
    <>
      ...
      {moreOpen && (
        <div className="fixed bottom-16 right-2 left-2 z-50 lg:hidden">
          <div className="bg-mns-surface border border-gray-700 rounded-xl shadow-2xl shadow-black/50 overflow-hidden mx-auto max-w-sm">
            {/* Draft section */}
      ...
      {/* Bottom tab bar */}
      <nav className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-mns-card border-t border-gray-700"
